...
Frontend web para interactuar con el sistema multiagente **Muppy**. Incluye una interfaz de chat moderna y conecta con el backend (FastAPI) a través del endpoint `POST /invoke`.
